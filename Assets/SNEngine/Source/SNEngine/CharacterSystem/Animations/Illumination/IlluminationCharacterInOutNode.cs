...
{
    public class IlluminationCharacterInOutNode : AnimationInOutNode<Character>, ISaveProgressNode
    {
        ...
        protected override void Play(Character target, float duration, AnimationBehaviourType type, Ease ease)
        {
            ...
            Illuminate(target, type, playDuration, playEase).Forget();
        }
        ...
        private async UniTask Illuminate(Character character, AnimationBehaviourType animationBehaviour, float duration, Ease ease)
        {
            ...
            await serviceCharacters.IlluminateCharacter(character, animationBehaviour, duration, ease);
