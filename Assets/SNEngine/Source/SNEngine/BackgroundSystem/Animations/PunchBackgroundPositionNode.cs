...
{
    public class PunchBackgroundPositionNode : AsyncNode
    {
        [Input(ShowBackingValue.Unconnected), SerializeField] private float _duration = 0.5f;
        [Input(ShowBackingValue.Unconnected), SerializeField] private Vector3 _punch = new Vector3(0.5f, 0, 0);
        ...
        public override async void Execute()
        {
            ...
            await service.PunchPosition(inputPunch, inputDuration, inputVibrato, inputElasticity);
            StopTask();
        }
    }
}