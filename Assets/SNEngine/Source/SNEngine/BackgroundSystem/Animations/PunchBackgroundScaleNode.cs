...
{
    public class PunchBackgroundScaleNode : AsyncNode
    {
        [Input(ShowBackingValue.Unconnected), SerializeField] private float _duration = 0.5f;
        [Input(ShowBackingValue.Unconnected), SerializeField] private Vector3 _punch = new Vector3(0.2f, 0.2f, 0.2f);
        ...
        public override async void Execute()
        {
            ...
            await service.PunchScale(inputPunch, inputDuration, inputVibrato, inputElasticity);
            StopTask();
        }
    }
}