...
{
    public class SetBackgroundLoopingRotateNode : AsyncNode
    {
        ...
        [Input(ShowBackingValue.Unconnected), SerializeField] private Vector3 _endValue = new Vector3(0, 0, 30);
        ...
        public override void Execute()
        {
            ...
            service.SetLoopingRotate(inputEndValue, inputDuration, inputLoopType, inputEase);
            StopTask();
        }
    }
}